...
H<- unstable.score(hmm= res, data= dna_hg19, n.threads = 1)

system("liftOver curated_tss.bed ../makeRecipBest/hg19.panTro4/axtChain/hg19.panTro4.rbest.chain.gz curated_tss.panTro4.bed unmap")
...
C<- unstable.score(hmm= res, data= dna_panTro4, n.threads = 1)

system("liftOver curated_tss.bed ../makeRecipBest/hg19.rheMac3/axtChain/hg19.rheMac3.rbest.chain.gz curated_tss.rheMac3.bed unmap")
...
M<- unstable.score(hmm= res, data= dna_rheMac3, n.threads = 1)

data.frame(tss_hg19, H, C, M)
