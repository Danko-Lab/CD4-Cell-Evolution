...
cp ~/nextgen/projects/GROseq/RawSequenceFiles/CD4/noadapt/*.fastq.gz $SCRATCH
cp ~/nextgen/projects/GROseq/RawSequenceFiles/CD4_nhp1_reseq/combine_pre_new_seq/H3*.fastq.gz $SCRATCH
cp ~/nextgen/projects/GROseq/RawSequenceFiles/CD4_nhp2_reseq/combine_pre_new_seq/H2*.fastq.gz $SCRATCH
cp ~/nextgen/projects/GROseq/RawSequenceFiles/CD4_nhp3_reseq/combine_pre_new_seq/H*.fastq.gz $SCRATCH
